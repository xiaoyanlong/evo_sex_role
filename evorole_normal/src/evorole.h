...
namespace evorole {
  ...
  struct genome_t
  {
    ...
    double pc1 = 20.0;       // female care days
    double pc2 = 20.0;       // male care days
  };
  ...
  struct mutation_t
  {
    ...
    double sigma_P = 0.01;        // standard deviation for p 
    double m_tau = 0.0;           // mutation rate for tau genes (ornaments)
    double sigma_tau = 0.01;      // standard deviation for tau 
    double m_pc = 0.005;          // mutational rate for gene pc1|2 (parental care)
    double sigma_pc = 0.1;        // standard deviation for pc1|2 (parental care)
  };
